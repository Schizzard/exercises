...
# your birthday from today. We could make this a real challenge though and 
# count the difference between any dates.
# You are given two dates as an array with three numbers - a year, month and 
# day. For example: 19 April 1982 will be (1982, 4, 19). You should find the 
...
# How it is used: Python has batteries included, so in this mission you’ll 
# need to learn how to use completed modules so that you don't have to invent 
# the bicycle all over again.
