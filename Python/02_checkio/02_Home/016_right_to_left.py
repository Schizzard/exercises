...
# "For centuries, left-handers have suffered unfair discrimination in a world 
...
# (say 5 percent to 30 percent) are left-handed, and an indeterminate number 
# of people are probably best described as ambidextrous."
# Scientific American. www.scientificamerican.com

# One of the robots is charged with a simple task: to join a sequence of 
# strings into one sentence to produce instructions on how to get around the 
# ship. But this robot is left-handed and has a tendency to joke around and 
# confuse its right-handed friends.

# You are given a sequence of strings. You should join these strings into a 
...
def left_join(phrases: tuple) -> str:
    ans = []
    for i in phrases :
        ans.append(str(i).replace('right','left'))
    return str(','.join(ans))
