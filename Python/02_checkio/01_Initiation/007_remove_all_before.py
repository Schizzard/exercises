...
# You need to remove from the list all of the elements before the given one.

# We have a list [1, 2, 3, 4, 5] and we need to remove all elements that go 
# before 3 - which is 1 and 2.
