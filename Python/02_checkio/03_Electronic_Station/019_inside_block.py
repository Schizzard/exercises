...
# need a functionality to determine if a point (a building or a tree) lies 
# inside the structure.

# For the purpose of this mission, a city structure may be considered a polygon 
# represented as a sequence of vertex coordinates on a plane or map. The 
# vertices are connected sequentially with the last vertex in the list 
# connecting to the first. We are given the coordinates of the point which we 
# need to check. If the point of impact lies on the edge of the polygon then it 
# should be considered inside of it. For this mission, you need to determine 
...
# How it is used: This concept is using for image recognizing. But as we said 
# early it can be useful for topographical software and city planning.
